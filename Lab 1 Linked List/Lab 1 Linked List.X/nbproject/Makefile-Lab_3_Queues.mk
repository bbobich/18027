...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Lab_3_Queues.mk dist/${CND_CONF}/${IMAGE_TYPE}/Lab_1_Linked_List.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/830430193/ListBox.o: ../Hood/Graphics/ListBox.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/830430193 
	@${RM} ${OBJECTDIR}/_ext/830430193/ListBox.o.d 
	@${RM} ${OBJECTDIR}/_ext/830430193/ListBox.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../Hood/Graphics/ListBox.c  -o ${OBJECTDIR}/_ext/830430193/ListBox.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/830430193/ListBox.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1  -mno-eds-warn  -omf=elf -mlarge-code -mlarge-data -mconst-in-code -O0 -I"../Hood/Board Support Package" -I"../Hood/Microchip/Include" -I"../Hood/Microchip/Include/Graphics" -I"." -I"../Hood/Microchip/Graphics/Drivers" -I"../Hood" -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/_ext/830430193/ListBox.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
