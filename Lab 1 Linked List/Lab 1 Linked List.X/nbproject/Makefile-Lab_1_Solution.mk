...
${OBJECTDIR}/_ext/1545724809/Beep.o: ../Hood/Board\ Support\ Package/Beep.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  "../Hood/Board Support Package/Beep.c"  -o ${OBJECTDIR}/_ext/1545724809/Beep.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1545724809/Beep.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -mno-eds-warn  -omf=elf -mlarge-code -mlarge-data -mconst-in-code -O0 -I"../Hood/Board Support Package" -I"../Hood/Microchip/Include" -I"../Hood/Microchip/Include/Graphics" -I"." -I"../Hood/Microchip/Graphics/Drivers" -I"../Hood" -DDEBUG -msmart-io=1 -Wall -msfr-warn=off
